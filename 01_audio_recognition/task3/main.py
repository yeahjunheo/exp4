...
text.set("0.0")
label = tkinter.Label(master=display_frame, textvariable=text, font=("", 30))
label.pack()

# remote for the karaoke
remote_controller_frame = tkinter.Frame(master=remote_frame)
remote_controller_frame.pack(side="top", fill="both")

# set pitch of the song
remote_pitch_frame = tkinter.Frame(master=remote_controller_frame)
remote_pitch_frame.pack(side="left", fill="both")
...
remote_tempo_frame = tkinter.Frame(master=remote_controller_frame)
remote_tempo_frame.pack(side="left", fill="both")
...
# set echo of the voice
remote_echo_frame = tkinter.Frame(master=remote_controller_frame)
remote_echo_frame.pack(side="left", fill="both")

echo_label = tkinter.Label(remote_echo_frame, text="Echo", font=("", 30), width=5)
echo_label.pack(side="top")

echo_up_btn = tkinter.Button(remote_echo_frame, text="+1", font=("", 30), width=3)
echo_up_btn.pack(side="top")

echo_value = tkinter.StringVar()
echo_value.set("0")
echo_label = tkinter.Label(remote_echo_frame, textvariable=echo_value, font=("", 30))
echo_label.pack(side="top")

echo_down_btn = tkinter.Button(remote_echo_frame, text="-1", font=("", 30), width=3)
echo_down_btn.pack(side="top")

# add voice change (woman or man)
